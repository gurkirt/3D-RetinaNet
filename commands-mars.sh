...
python main.py --MODE=gen_dets --MODEL_TYPE=C2D --TEST_SEQ_LEN=8 --TRAIN_SUBSETS=train_3 --SEQ_LEN=8 --BATCH_SIZE=4
python main.py --MODE=gen_dets --MODEL_TYPE=C2D --TEST_SEQ_LEN=32 --TRAIN_SUBSETS=train_3 --SEQ_LEN=8 --BATCH_SIZE=4
python main.py --MODE=gen_dets --MODEL_TYPE=RCLSTM --TEST_SEQ_LEN=8 --TRAIN_SUBSETS=train_3 --SEQ_LEN=8 --BATCH_SIZE=4
python main.py --MODE=gen_dets --MODEL_TYPE=RCLSTM --TEST_SEQ_LEN=32 --TRAIN_SUBSETS=train_3 --SEQ_LEN=8 --BATCH_SIZE=4
